...
\begin{figure}
    \centering
    \includegraphics[width = 0.3\linewidth]{ShiftedLatticePoints-eps-converted-to.pdf} \qquad	\includegraphics[width=0.64\linewidth]{"optPrice_guaranteed_time_full_Baker_d12_r1_2018-Sep-6"}
