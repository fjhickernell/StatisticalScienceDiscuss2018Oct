...
\end{multline*}
The covariance function in \eqref{the_kernel_eqn_bernoulli} is an example of a shift-invariant covariance function.  Figure \ref{fig:latfig} depicts a rank-1 integration node set.

\begin{figure}
    \centering
    \includegraphics[width = 5cm]{ShiftedLatticePoints-eps-converted-to.pdf}
    \caption{Caption}
    \label{fig:latfig}
\end{figure}
